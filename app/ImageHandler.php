...
class ImageHandler {
    /**
     * Validates and saves a base64 encoded image
     * 
     * @param string $base64Data The base64 encoded image data
     * @param bool $save_image Whether to save the image or just validate
     * @return array Result array with success status and additional information
     */
    public static function validateAndSaveImage($base64Data, $save_image = true) {
        // Decode base64 data
